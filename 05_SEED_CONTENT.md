...
- Pour chaque école : **5 professeurs** (`teacherX.ecole-1@poleapp.test`, `teacherX.ecole-2@poleapp.test`) et **10 élèves** (`studentX.ecole-1@poleapp.test`, `studentX.ecole-2@poleapp.test`), mot de passe `change-me-password`, premium pour 1 élève sur 2. Les noms affichés sont génériques (`Teacher X`, `Student X`).
