...
export function WeekView({ initialWeek, initialPrev, initialNext, initialDays, filters, baseFrom, compact }: Props) {
  ...
  const storageKey = "teacher-agenda:show-empty-days";
  ...
  return (
    <section className={containerClass}>
      ...
      <div className="mt-3 grid grid-cols-1 gap-1.5 sm:grid-cols-2 md:grid-cols-4 md:gap-3 lg:grid-cols-7">
        {days.map((day) => {
          const isToday =
