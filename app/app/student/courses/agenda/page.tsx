        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-slate-200">
              Navigation hebdo/mensuelle sans rechargement. Les jours avec cours suivis sont marqués.
            </p>
          </div>
            ...
            <fieldset className="text-sm text-slate-200">
              ...
              {disciplines.length > 6 && (
                <details className="mt-2 space-y-2">
                  ...
                  <div className="grid max-h-32 grid-cols-2 gap-2 overflow-auto pr-1 md:grid-cols-3">
