      ...
      <section className="panel relative flex flex-col gap-3 overflow-hidden p-5 text-sm text-slate-200 md:flex-row md:items-center md:justify-between">
        ...
        <div className="relative flex flex-wrap items-center gap-2 md:justify-end">
          {session?.user ? (
            ...
            <Link
              href="/login"
              className="rounded-full border border-indigo-200/70 bg-gradient-to-r from-indigo-500 via-purple-500 to-cyan-400 px-4 py-2 font-semibold text-white shadow-lg shadow-indigo-900/30 transition hover:brightness-110 hover:-translate-y-0.5"
