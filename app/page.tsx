      ...
      <section className="panel relative flex flex-col gap-3 overflow-hidden p-5 text-sm text-slate-200 md:flex-row md:items-center md:justify-between">
        ...
        <div className="relative flex flex-wrap items-center gap-2 md:justify-end">
          {session?.user ? (
            ...
            <Link
              href="/login"
              className="rounded-full border border-cyan-100/80 bg-cyan-500 px-4 py-2 font-semibold text-slate-900 shadow-lg shadow-indigo-900/30 transition hover:bg-cyan-400 hover:border-cyan-50 hover:-translate-y-0.5 active:translate-y-[1px]"
