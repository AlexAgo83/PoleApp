          ...
          {partners.map((partner) => (
            ...
            >
              {(() => {
                ...
                const editHref = `/admin/partners${editParams.toString() ? `?${editParams.toString()}` : ""}`;
                const cancelHref = `/admin/partners${baseParams.toString() ? `?${baseParams.toString()}` : ""}`;
