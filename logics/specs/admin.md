...
[Aligné v0.14.0 | Compréhension: 88% | Confiance: 80% | Avancement: 100% | Portée: `/app/admin/*`]
...
- Dashboard : vue semaine inline cours + bouton semaine actuelle.
...
- Facturation admin : table factures avec filtres/statuts, actions statut (toasts), export CSV.
- Partenaires : CRUD + tracking clic/achat.

## UX cible
- Dashboard calendrier semaine + cartes synthèse.
