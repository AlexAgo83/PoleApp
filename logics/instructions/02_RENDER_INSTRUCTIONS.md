...
- **Variables Render à vérifier** : `DATABASE_URL` (Postgres Render), `NEXTAUTH_SECRET`, `NEXTAUTH_URL`. Sans `DATABASE_URL`, le build échoue dès Prisma.
...
1) Modifier `prisma/schema.prisma`, puis `npx prisma generate`.
